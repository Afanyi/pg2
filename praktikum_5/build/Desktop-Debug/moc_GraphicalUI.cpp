...
struct qt_meta_stringdata_CLASSGraphicalUIENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGraphicalUIENDCLASS = QtMocHelpers::stringData(
    "GraphicalUI",
    "switchWindow",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGraphicalUIENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject GraphicalUI::staticMetaObject = { {
    QMetaObject::SuperData::link<MainWindow::staticMetaObject>(),
    qt_meta_stringdata_CLASSGraphicalUIENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGraphicalUIENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGraphicalUIENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *GraphicalUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGraphicalUIENDCLASS.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "AbstractView"))
        return static_cast< AbstractView*>(this);
    if (!strcmp(_clname, "AbstractController"))
        return static_cast< AbstractController*>(this);
